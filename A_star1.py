...
import random
import numpy as np
coordinates = np.load('co-ordinates.npy')
print(coordinates)
...
while(l<len(coordinates)):
    x_final = 30
    y_final = 30
    if coordinates[l][2]==2:
        x_last = coordinates[l][0]
        y_last = coordinates[l][1]
    l = l+1

n = x_last # horizontal size of the map
m = y_last # vertical size of the map
the_map = []
row = [0] * n
...
while(l<len(coordinates)):
    x_final = 30
    y_final = 30
    if coordinates[l][2]==0:
        the_map[coordinates[l][0]][coordinates[l][1]] = 1
    if coordinates[l][2]==2:
        x_last = coordinates[l][0]
        y_last = coordinates[l][1]
    l = l+1
...
(xA, yA, xB, yB)=(0,0,x_final,y_final)
